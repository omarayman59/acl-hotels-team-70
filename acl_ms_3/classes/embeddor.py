...
descriptions = {
    "Traveller": "Traveller with ID {user_id} is a {age}-year-old {gender} {type} traveller.",
    "Hotel": "{name} is a {star_rating}-star hotel with an average review score of {average_reviews_score}. Ratings: cleanliness {cleanliness_base}, comfort {comfort_base}, facilities {facilities_base}, staff {staff_base}, location {location_base}, and value for money {value_for_money_base}.",
    "City": "The city of {name} is a travel destination.",
    "Country": "The country of {name} is a travel destination.",
...
class Embeddor:
    ...
    def generate_description(
        ...
        template = descriptions.get(node_label)
